...
if __name__ == "__main__":
    ...
    # solve('calk_evalWithNumber_quotient=5*5')
    ...
    # print('OK')
    # solve('calk_evalWithNumber_quotient=441/21+357/21')
    solve('polynomial_squareDif_equation=(100-1)^2')
    solve('calk_evalWithNumber_quotient=100^2')